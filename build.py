...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','co.saiten.ti.socket.io.js')
	...
	f = os.path.join(cwd,'Classes','CoSaitenTiSocketIoModuleAssets.m')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','co.saiten.ti.socket.io.js']
